  ...
  return (
    <div className="w-full h-screen flex items-center justify-center ">
      <div className="flex flex-col items-center justify-center max-w-[450px]  gap-y-4  ">
        <div className="flex flex-col border border-neutral-300 p-[40px] gap-y-4 rounded-md ">
        ...
        <div className="flex gap-x-1 items-center justify-center py-5  border rounded-md  border-neutral-300 w-full">
